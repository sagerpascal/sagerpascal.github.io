...
has the correct target symbol as input, part of the input gets masked. In this case, the sequence $$\[S_{t}, ?\]$$ is fed into the translation layer.
...
now predicts the second symbol $$S_{t+2}$$. 
